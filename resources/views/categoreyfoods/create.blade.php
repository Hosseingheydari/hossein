<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <h2><a href="{{ route('categoreyfoods.index') }}"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form class="p-5" action="{{ route('categoreyfoods.store') }}" method="post">
                        @csrf
                        <div class="grid gap-6 mb-6 lg:grid-cols-2">
                            <div>
                                <label for="cat_food"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">CatFood</label>
                                <input type="text" name="cat_food" id="cat_food"
